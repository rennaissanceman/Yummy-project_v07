...
public interface RequestPaymentProcessingMapper {

    @Mapping(source = "paymentMethod", target = "paymentMethod", qualifiedByName = "enumToString")
    RequestPaymentProcessingDTO toDTO(RequestPaymentProcessing request);

    @Mapping(source = "paymentMethod", target = "paymentMethod", qualifiedByName = "stringToEnum")
    RequestPaymentProcessing toDomain(RequestPaymentProcessingDTO dto);
