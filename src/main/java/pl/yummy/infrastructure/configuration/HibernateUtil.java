    ...
    private static SessionFactory loadSessionFactory() {
        try {
            ...
            Metadata metadata = new MetadataSources(standardServiceRegistry)
                    ...
                    .addAnnotatedClass(ZAvailableStreetEntity.class)
                    ...
                    .addAnnotatedClass(ZDeliveryAddressEntity.class)
                    .addAnnotatedClass(ZDeliveryEntity.class)
                    .addAnnotatedClass(ZFoodEntity.class)
                    .addAnnotatedClass(ZInvoiceEntity.class)
                    .addAnnotatedClass(ZMenuEntity.class)
                    .addAnnotatedClass(ZMenuItemEntity.class)
                    .addAnnotatedClass(ZOrderEntity.class)
                    .addAnnotatedClass(ZOrderItemEntity.class)
                    .addAnnotatedClass(OwnerEntity.class)
                    .addAnnotatedClass(ZPaymentEntity.class)
