    ...
    private static SessionFactory loadSessionFactory() {
        try {
            ...
            Metadata metadata = new MetadataSources(standardServiceRegistry)
                    ...
                    .addAnnotatedClass(AvailableStreetEntity.class)
                    .addAnnotatedClass(BillingInformationEntity.class)
                    .addAnnotatedClass(ContactDetailsEntity.class)
                    .addAnnotatedClass(CourierEntity.class)
                    .addAnnotatedClass(CustomerEntity.class)
                    .addAnnotatedClass(DeliveryAddressEntity.class)
                    ...
                    .addAnnotatedClass(PersonalDataEntity.class)
                    .addAnnotatedClass(ReceiptEntity.class)
                    .addAnnotatedClass(RestaurantAvailableStreetEntity.class)
                    .addAnnotatedClass(RestaurantEntity.class)
                    .addAnnotatedClass(UserLogDataEntity.class)
                    .getMetadataBuilder()
                    .build();
